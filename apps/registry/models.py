...
class UserCompanyProfile(SearchNormalizedMixin, models.Model):
    user = models.OneToOneField(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="company_profile", verbose_name="Хэрэглэгч")
    company = models.ForeignKey(Company, on_delete=models.PROTECT, related_name="user_profiles", verbose_name="Харьяалах компани", null=True, blank=True)
